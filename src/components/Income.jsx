      ...
      <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col gap-8">
        ...
        <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
          ...
          <div className="flex gap-3">
            ...
            <button className="flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-sm font-bold text-on-primary shadow-[0_4px_20px_rgba(46,50,48,0.06)] transition-colors hover:bg-primary/90">
