...
export default function RecordInvoiceForm() {
    ...
    <div className="sticky top-24 rounded-2xl border border-outline-variant/10 bg-surface-container-lowest p-6 shadow-[0_4px_20px_rgba(46,50,48,0.08)]">
      ...
      >
        ...
        <div className="flex gap-3 border-t border-outline-variant/20 pt-4">
          ...
          <button
            type="button"
            className="flex-[2] rounded-xl bg-primary px-4 py-2.5 text-sm font-bold text-on-primary shadow-sm transition-colors hover:bg-primary/90"
          >
            Save Invoice
          </button>
        </div>
